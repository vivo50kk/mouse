...
def max_scoring_num_rolls(dice=six_sided, samples_count=1000):
    ...
    "*** YOUR CODE HERE ***"
    maxa=0
    ave_d=make_averaged(roll_dice,samples_count)
    max=0
    for i in range(1,11):
        a=ave_d(i,dice)
        if a>max:
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    ...
    if sus_update(0,score,opponent_score)>=100:
        return 0
    elif sus_update(1,score,opponent_score)>=100:
        return 1
    elif sus_update(2,score,opponent_score)>=100:
        return 2
    else:
        return sus_strategy(score,opponent_score,sus_update(6,score,opponent_score)-score)
